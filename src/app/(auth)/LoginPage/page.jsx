               ...
               <div className="bg-white p-10 rounded-[2.5rem] border border-slate-200 shadow-2xl space-y-8 relative overflow-hidden">
                  ...
                  <form onSubmit={onSubmit} className="space-y-6">
                     ...
                     <div className="space-y-2">
                        ...
                        <div className="flex items-center gap-3 border-2 border-slate-200 hover:border-blue-600/50 focus-within:border-blue-600 transition-all duration-300 h-14 bg-white w-full rounded-2xl px-4">
