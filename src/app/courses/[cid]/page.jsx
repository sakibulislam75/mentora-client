...
import { singleCourse } from '@/lib/data';
...
export default async function CourseDetails({ params }) {
   ...
   const course = await singleCourse(cid);
            ...
            <div className="lg:col-span-2 space-y-8">
               ...
               <div className="space-y-4">
                  ...
                  <p className="text-xl text-slate-500 leading-relaxed">
                     Master the core concepts of this subject with our comprehensive guide designed
               ...
               <p className="text-xs font-bold text-slate-400 italic">Last enrolled:</p>
            </div>
               ...
               <div className="sticky top-24 bg-white/70 backdrop-blur-md p-8 rounded-[2rem] border border-white/20 shadow-2xl space-y-8">
                  ...
                  <div className="space-y-4">
                     ...
                     <ul className="space-y-3">
                        {['Lifetime Access', 'Expert Guidance', 'Verified Certificate'].map(
                           (item, i) => (
                              <li
                                 key={i}
